...
<dt>&lsquo;<samp>-itsscale <var>scale</var> (<em>input,per-stream</em>)</samp>&rsquo;</dt>
...
<dt>&lsquo;<samp>-dn (<em>input/output</em>)</samp>&rsquo;</dt>
...
<dt>&lsquo;<samp>-vn (<em>input/output</em>)</samp>&rsquo;</dt>
...
<dt>&lsquo;<samp>-an (<em>input/output</em>)</samp>&rsquo;</dt>
...
<dt>&lsquo;<samp>-sn (<em>input/output</em>)</samp>&rsquo;</dt>
...
<dt>&lsquo;<samp>-dts_error_threshold <var>seconds</var></samp>&rsquo;</dt>
<dd><p>Timestamp error delta threshold. This threshold use to discard crazy/damaged
timestamps and the default is 30 hours which is arbitrarily picked and quite
conservative.
</p></dd>
<dt>&lsquo;<samp>-muxdelay <var>seconds</var> (<em>output</em>)</samp>&rsquo;</dt>
<dd><p>Set the maximum demux-decode delay.
</p></dd>
<dt>&lsquo;<samp>-muxpreload <var>seconds</var> (<em>output</em>)</samp>&rsquo;</dt>
